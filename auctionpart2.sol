...
contract Auction {
    ...
    struct Item {
        ...
        uint[] itemTokens;  //array holding tokens bid in favor of the item
	}
   ...
   //Structure to hold the details of a persons
    ...
    mapping(address => Person) tokenDetails; //tokenDetails is the dictionary mapping address to Person structure
    ...
    //constructor
    //Part 1 Task 1. Initialise beneficiary with address of smart contract’s owner
    ...
    function bid(uint _itemId, uint _count) public payable{
        ...
        4.1 If the number of tokens remaining with the bidder is < < count of tokens to be bidded, revert.
        ...
        if (tokenDetails[msg.sender].remainingTokens < _count || _itemId > 2 || tokenDetails[msg.sender].remainingTokens == 0){revert();}    
                //** End code here. **
